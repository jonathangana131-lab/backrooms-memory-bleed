...
// District/EdgeCode are const enums - referenced only as types here so the
...
/** Height of the projected quad above the floor. */
export const PROJECTION_Y = 1.55;
/** How far the quad floats off its wall (spec: 0.02 m). */
 ...
 *
 * rotY follows the SignInstance face convention (0=-z 1=+z 2=-x 3=+x wall
 * normal) translated to yaw so the quad faces into the corridor.
 */
